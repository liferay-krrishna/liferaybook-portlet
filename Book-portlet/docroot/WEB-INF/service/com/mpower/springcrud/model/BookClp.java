...
import com.mpower.springcrud.service.ClpSerializer;
	...
	public void setBookType(String bookType) {
		...
		if (_bookRemoteModel != null) {
			try {
				...
				Method method = clazz.getMethod("setBookType", String.class);

				method.invoke(_bookRemoteModel, bookType);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
